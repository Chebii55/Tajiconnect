      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-[#1C3D6E]">Privacy Policy</h1>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="prose prose-lg max-w-none">
              <div className="bg-blue-50 border-l-4 border-[#3DAEDB] p-6 rounded-r-lg mb-8">
                <h2 className="text-xl font-bold text-[#1C3D6E] mb-2">Quick Summary</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">1. Information We Collect</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">2. How We Use Your Information</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">3. Information Sharing</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">4. Data Security</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 border border-gray-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Hosted on industry-standard secure infrastructure</p>
                  </div>
                  <div className="text-center p-4 border border-gray-200 rounded-lg">
                    <div className="text-2xl mb-2">👥</div>
                    <h3 className="font-semibold mb-2">Limited Access</h3>
                    <p className="text-sm text-gray-600">Only authorized personnel have access to your data</p>
                  </div>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">5. Your Rights and Choices</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">6. Cookies and Tracking</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">Help us understand usage patterns (opt-out available)</p>
                  </div>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">7. Children's Privacy</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">8. International Data Transfers</h2>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">9. Changes to This Policy</h2>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">10. Contact Us</h2>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-4">
