      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-[#1C3D6E]">Terms of Service</h1>
              <p className="text-gray-600">Your rights and responsibilities using TajiConnect</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <div className="prose prose-lg max-w-none">
              <div className="bg-amber-50 border-l-4 border-amber-400 p-6 rounded-r-lg mb-8">
                <h2 className="text-xl font-bold text-[#1C3D6E] mb-2 flex items-center gap-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">1. Acceptance of Terms</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">2. User Accounts and Eligibility</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">3. Platform Usage</h2>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-3">All user-generated content must:</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">4. Intellectual Property</h2>
                <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg mb-4">
                  <h3 className="font-semibold text-[#1C3D6E] mb-2 flex items-center gap-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">5. Payment and Subscription Terms</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 border border-[#3DAEDB] bg-blue-50 rounded-lg">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">6. Limitation of Liability</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">7. Termination</h2>
                <p className="text-gray-700 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">8. Changes to Terms</h2>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">9. Governing Law</h2>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#1C3D6E] mb-4">10. Contact Information</h2>
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700 mb-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">legal@tajiconnect.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
