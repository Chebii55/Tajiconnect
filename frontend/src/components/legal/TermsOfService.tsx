      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-primary-dark dark:text-white">Terms of Service</h1>
              <p className="text-neutral-dark/70 dark:text-gray-400">Your rights and responsibilities using TajiConnect</p>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white dark:bg-[#1e2433] rounded-xl shadow-lg dark:shadow-2xl dark:shadow-black/20 p-8 dark:border dark:border-gray-700/50">
            <div className="prose prose-lg max-w-none">
              <div className="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-400 dark:border-amber-500 p-6 rounded-r-lg mb-8">
                <h2 className="text-xl font-bold text-primary-dark dark:text-white mb-2 flex items-center gap-2">
                  <AlertTriangle className="w-5 h-5 text-amber-600 dark:text-amber-400" />
                  Important Notice
                </h2>
                <p className="text-neutral-dark/80 dark:text-amber-200/80">
              ...
              <section className="mb-8">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border dark:border-blue-700/50">
                  <p className="text-sm text-neutral-dark/80 dark:text-blue-200">
                    <strong className="dark:text-white">Note:</strong> These terms constitute a legally binding agreement between you and TajiConnect.
                  </p>
                </div>
              </section>

              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">2. User Accounts and Eligibility</h2>

                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">2.1 Age Requirements</h3>
                <ul className="list-disc ml-6 space-y-2 text-neutral-dark/80 dark:text-gray-300 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">2.2 Account Responsibilities</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-50 dark:bg-emerald-900/20 p-4 rounded-lg border dark:border-emerald-700/50">
                    <h4 className="font-semibold text-green-900 dark:text-emerald-300 mb-2 flex items-center gap-2">
                      <UserCheck className="w-4 h-4" />
                      Your Responsibilities
                    </h4>
                    <ul className="text-sm text-green-800 dark:text-emerald-200/80 space-y-1">
                  ...
                  <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border dark:border-red-700/50">
                    <h4 className="font-semibold text-red-900 dark:text-red-300 mb-2 flex items-center gap-2">
                      <AlertTriangle className="w-4 h-4" />
                      Prohibited Actions
                    </h4>
                    <ul className="text-sm text-red-800 dark:text-red-200/80 space-y-1">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">3. Platform Usage</h2>

                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">3.1 Permitted Use</h3>
                <p className="text-neutral-dark/80 dark:text-gray-300 mb-4">
                  TajiConnect is designed for educational purposes. You may use the platform to:
                </p>
                <ul className="list-disc ml-6 space-y-2 text-neutral-dark/80 dark:text-gray-300 mb-6">
                ...
                <div className="bg-gray-50 dark:bg-[#1a1f2e] p-6 rounded-lg border dark:border-gray-700/50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <ul className="text-sm text-neutral-dark/80 dark:text-gray-300 space-y-2">
                      <li className="text-green-700 dark:text-emerald-400">✓ Be respectful and appropriate</li>
                      <li className="text-green-700 dark:text-emerald-400">✓ Comply with applicable laws</li>
                      <li className="text-green-700 dark:text-emerald-400">✓ Respect intellectual property rights</li>
                      <li className="text-green-700 dark:text-emerald-400">✓ Be accurate and truthful</li>
                    </ul>
                    <ul className="text-sm text-neutral-dark/80 dark:text-gray-300 space-y-2">
                      <li className="text-red-700 dark:text-red-400">✗ Contain hate speech or discrimination</li>
                      <li className="text-red-700 dark:text-red-400">✗ Include violent or harmful content</li>
                      <li className="text-red-700 dark:text-red-400">✗ Violate privacy or confidentiality</li>
                      <li className="text-red-700 dark:text-red-400">✗ Spread misinformation</li>
                    </ul>
                  </div>
                </div>
              </section>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">4. Intellectual Property</h2>
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700/50 p-6 rounded-lg mb-4">
                  <h3 className="font-semibold text-primary-dark dark:text-white mb-2 flex items-center gap-2">
                    <Shield className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                    Platform Content
                  </h3>
                  <p className="text-neutral-dark/80 dark:text-blue-200/80">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">4.1 User Content License</h3>
                <p className="text-neutral-dark/80 dark:text-gray-300 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">5. Payment and Subscription Terms</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 border-2 border-primary dark:border-emerald-500 bg-blue-50 dark:bg-emerald-900/20 rounded-lg">
                    <h4 className="font-semibold mb-2 dark:text-white">Premium Features</h4>
                    <ul className="text-sm text-neutral-dark/80 dark:text-gray-300 space-y-1">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3 mt-6">5.2 Billing and Refunds</h3>
              ...
              <section className="mb-8">
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700/50 p-6 rounded-lg">
                  <p className="text-gray-800 dark:text-yellow-200 mb-4">
                    <strong className="dark:text-yellow-100">Important:</strong> TajiConnect provides educational guidance and job recommendations
                    based on available data and algorithms. We cannot guarantee:
                  </p>
                  <ul className="text-sm text-neutral-dark/80 dark:text-yellow-200/80 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">7. Termination</h2>
                <p className="text-neutral-dark/80 dark:text-gray-300 mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">7.1 Data Retention</h3>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">8. Changes to Terms</h2>
                <p className="text-neutral-dark/80 dark:text-gray-300">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-primary-dark dark:text-white mb-4">9. Governing Law</h2>
                <p className="text-neutral-dark/80 dark:text-gray-300">
                  These terms are governed by the laws of Kenya without regard to conflict of law principles.
                  Any disputes will be resolved through binding arbitration or in the courts of Kenya.
                </p>
              </section>
                ...
                <div className="bg-gray-50 dark:bg-[#1a1f2e] p-6 rounded-lg border dark:border-gray-700/50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium dark:text-white">Legal Team</p>
                        <p className="text-sm text-neutral-dark/70 dark:text-gray-400">legal@tajiconnect.com</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
