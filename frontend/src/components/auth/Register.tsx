...
const Register: React.FC = () => {
  ...
  const handleGoogleRegister = () => {
    ...
    // Redirect to Google OAuth - same flow as login, backend handles new user creation
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-2xl p-8 border dark:border-gray-700">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-gray-300 dark:hover:border-gray-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
          >
            {isGoogleLoading ? (
          ...
          >
            ...
            {showEmailRegister ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
          </button>
