      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 text-center">
              <div className="text-2xl font-bold text-secondary">{formatDuration(totalMinutesThisWeek)}</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Total This Week</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 text-center">
              <div className="text-2xl font-bold text-primary">{Math.round(avgSessionLength)}m</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Avg Session</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 text-center">
              <div className="text-2xl font-bold text-forest-sage">{Math.round(avgFocusScore)}</div>
              <div className="text-sm text-gray-600 dark:text-gray-300">Focus Score</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 text-center">
              <div className="text-2xl font-bold text-primary-dark dark:text-darkMode-link">{mockSessions.length}</div>
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Weekly Progress Comparison</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {mockWeeklyComparison.map((week, index) => (
                  <div key={index} className="text-center p-4 border border-gray-200 rounded-lg">
                    <h3 className="font-semibold text-primary-dark dark:text-darkMode-link mb-2">{week.week}</h3>
                    <div className="text-2xl font-bold text-secondary mb-1">{week.totalHours}h</div>
            ...
            {/* Daily Activity */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Daily Activity Overview</h2>
              <div className="space-y-4">
                {mockDailyStats.map((day, index) => (
                  <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center gap-4">
                      <div className="text-center">
                        <div className="font-bold text-primary-dark dark:text-darkMode-link">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-4">
                          <div>
                            <div className="font-semibold text-primary-dark dark:text-darkMode-link">{formatDuration(day.totalMinutes)}</div>
                    ...
                    <div className="text-right">
                      <div className="text-sm font-medium text-primary">Focus: {day.avgFocusScore}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Time by Category</h2>
                <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Recent Sessions</h2>
                  ...
                  {mockSessions.slice(0, 5).map((session) => (
                    <div key={session.id} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-primary-dark dark:text-darkMode-link text-sm">{session.activity}</div>
                      ...
                      <div className="text-right">
                        <div className="font-semibold text-secondary">{formatDuration(session.duration)}</div>
        ...
        {activeTab === 'patterns' && (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Learning Time by Hour</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-secondary">{peakHour.hour}:00</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-primary-dark dark:text-darkMode-link mb-4">Preferred Learning Times</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                    <span className="font-medium text-primary-dark dark:text-darkMode-link">🌅 Morning (6-12 PM)</span>
                    <span className="font-bold text-secondary">45%</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                    <span className="font-medium text-primary-dark dark:text-darkMode-link">🌞 Afternoon (12-6 PM)</span>
                    <span className="font-bold text-primary">35%</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    <span className="font-medium text-primary-dark dark:text-darkMode-link">🌙 Evening (6+ PM)</span>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-primary-dark dark:text-darkMode-link mb-4">Session Length Distribution</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-primary-dark dark:text-darkMode-link">Short (&lt; 30min)</span>
                    <span className="font-bold text-secondary">25%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-primary-dark dark:text-darkMode-link">Medium (30-60min)</span>
                    <span className="font-bold text-primary">50%</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-primary-dark dark:text-darkMode-link">Long (60+ min)</span>
        ...
        {activeTab === 'focus' && (
          <div className="space-y-6">
            {/* Focus Score Trends */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Focus Score Analysis</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="text-center p-4 bg-green-50 rounded-lg">
                  <div className="text-2xl font-bold text-secondary">{Math.round(avgFocusScore)}</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Average Focus Score</div>
                </div>
                <div className="text-center p-4 bg-blue-50 rounded-lg">
                  <div className="text-2xl font-bold text-primary">{Math.max(...mockSessions.map(s => s.focusScore))}</div>
              ...
              {/* Focus by Category */}
              <div className="space-y-4">
                <h3 className="font-semibold text-primary-dark dark:text-darkMode-link">Focus Score by Activity Type</h3>
                {Object.entries(
                  mockSessions.reduce((acc, session) => {
                  ...
                  return (
                    <div key={category} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-secondary w-8">{avgScore}</span>
                      </div>
                    </div>
                  )
                })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-primary-dark dark:text-darkMode-link mb-4">Focus Factors</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      <span>🖥️</span>
                      <span className="text-primary-dark dark:text-darkMode-link">Desktop Learning</span>
                    </div>
                    <span className="font-bold text-secondary">+15% focus</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      <span>🌅</span>
                      <span className="text-primary-dark dark:text-darkMode-link">Morning Sessions</span>
                    </div>
                    <span className="font-bold text-primary">+12% focus</span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      <span>📚</span>
                      <span className="text-primary-dark dark:text-darkMode-link">Course Content</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      <span>📱</span>
                      <span className="text-primary-dark dark:text-darkMode-link">Mobile Learning</span>
                    </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                <h3 className="text-lg font-bold text-primary-dark dark:text-darkMode-link mb-4">Improvement Suggestions</h3>
                <div className="space-y-3">
        ...
        {activeTab === 'insights' && (
          <div className="space-y-6">
            {/* Key Insights */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Personalized Insights</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
            ...
            {/* Habit Formation */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Learning Habit Analysis</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="w-16 h-16 bg-secondary rounded-full flex items-center justify-center mx-auto mb-3">
                    <span className="text-2xl">🔥</span>
                  </div>
                  <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-2">Consistency Score</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-2">Time Stability</h3>
                  <div className="text-3xl font-bold text-primary mb-2">92%</div>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Consistent learning times established</p>
                </div>

                <div className="text-center">
                  <div className="w-16 h-16 bg-forest-sage rounded-full flex items-center justify-center mx-auto mb-3">
                    <span className="text-2xl">🎯</span>
                  </div>
                  <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-2">Focus Stability</h3>
                  <div className="text-3xl font-bold text-forest-sage mb-2">78%</div>
            ...
            {/* Action Plan */}
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              <h2 className="text-xl font-bold text-primary-dark dark:text-darkMode-link mb-6">Recommended Action Plan</h2>
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 border border-gray-200 rounded-lg">
                  <div className="w-8 h-8 bg-secondary text-white rounded-full flex items-center justify-center font-bold">1</div>
                  <div>
                    <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-1">Optimize Peak Hours (This Week)</h3>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-200 rounded-lg">
                  ...
                  <div>
                    <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-1">Improve Mobile Learning (Next 2 Weeks)</h3>
                ...
                <div className="flex items-start gap-4 p-4 border border-gray-200 rounded-lg">
                  <div className="w-8 h-8 bg-forest-sage text-white rounded-full flex items-center justify-center font-bold">3</div>
                  <div>
                    <h3 className="font-bold text-primary-dark dark:text-darkMode-link mb-1">Structured Break System (This Month)</h3>
