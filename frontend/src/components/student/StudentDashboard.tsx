          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{studentName}</span>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex-1">
                          <div className="flex justify-between text-sm mb-1">
                            <span className="text-gray-600 dark:text-gray-400">{course.progress}% complete</span>
                            <span className="text-green-600">{course.timeRemaining} left</span>
                          </div>
                  ...
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-4">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                        ...
                        activity.type === 'start' ? 'bg-blue-100 dark:bg-blue-900/30' :
                        activity.type === 'achievement' ? 'bg-purple-100 dark:bg-purple-900/30' :
                        'bg-orange-100 dark:bg-orange-900/30'
                      }`}>
                        {activity.type === 'completion' && <Trophy className="w-4 h-4 text-green-600" />}
                        {activity.type === 'start' && <BookOpen className="w-4 h-4 text-blue-600" />}
                        {activity.type === 'achievement' && <Award className="w-4 h-4 text-purple-600" />}
                        {activity.type === 'submission' && <Target className="w-4 h-4 text-orange-600" />}
                      </div>
                      <div className="flex-1">
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full flex items-center justify-between p-3 text-left bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">Take Assessment</span>
                    </div>
                    <ChevronRight className="w-4 h-4 text-gray-400" />
                  </button>
                  ...
                  <button className="w-full flex items-center justify-between p-3 text-left bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-900 dark:text-white">Ask Question</span>
                    </div>
                    <ChevronRight className="w-4 h-4 text-gray-400" />
                  </button>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Complete 3 courses this month</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">Maintain 90% average score</span>
