...
1. **Motivation (WHY)** – why the learner is here  
2. **Capability (WHERE)** – current skill level  
3. **Behavior (HOW)** – learning style & time availability
...
5. Time & commitment  
6. Language focus & personalization
...
{  
  "motivation": "culture",  
  "level": "beginner",  
  "learning\_style": "audio",  
  "time\_commitment": "short\_daily",  
  "language": "swahili"  
}
...
{  
  ...
  "level": "beginner",  
  "learning\_style": "audio",  
  "time\_commitment": "short",  
  "target\_language": "swahili",  
